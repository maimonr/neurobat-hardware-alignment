...
clock_diff_range = abs(median(clock_differences_at_pulses(end-10:end)) - median(clock_differences_at_pulses(1:10)));
err_differences_idx = find(abs(diff(clock_differences_at_pulses)) > clock_diff_range) + 1;
